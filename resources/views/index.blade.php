    ...
    <div class="header-container container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Destinos</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="destinos-nacionales.html">Nacionales</a></li>
              <li><a href="destinos-internacionales.html">Internacionales</a></li>
              <li><a href="ofertas.html">Ofertas Especiales</a></li>
            </ul>
          </li>
          <li class="dropdown"><a href="#"><span>Paquetes</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="paquetes-aventura.html">Aventura</a></li>
              <li><a href="paquetes-playa.html">Playa</a></li>
              <li><a href="paquetes-culturales.html">Culturales</a></li>
              <li><a href="paquetes-romanticos.html">Románticos</a></li>
              <li><a href="paquetes-familiares.html">Familiares</a></li>
            </ul>
          </li>
      ...
      <a class="btn-getstarted" href="reservas.html">Reservar Ahora</a>
  ...
  <main class="main">
        ...
        <div class="row align-items-center">
          <div class="col-lg-7">
            <div class="hero-text" data-aos="fade-up" data-aos-delay="100">
              <h1 class="hero-title">Descubre los destinos más increíbles</h1>
              <p class="hero-subtitle">Explora lugares únicos y vive experiencias inolvidables con nuestros paquetes turísticos personalizados.</p>
        ...
        <div class="row gy-4">
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            <div class="box">
              ...
              <p>Más de 10 años creando experiencias de viaje inolvidables para nuestros clientes.</p>
              ...
              <div class="stats-row">
                <div class="stat-item">
                  <span data-purecounter-start="0" data-purecounter-end="32" data-purecounter-duration="2" class="purecounter">0</span>
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="about-image">
              ...
              <div class="experience-badge">
                ...
                <div class="experience-text">Años de Experiencia</div>
              </div>
            </div>
          </div>
    ...
    <section id="featured-destinations" class="featured-destinations section">
      <div class="container section-title" data-aos="fade-up">
        ...
        <div><span>Conoce Nuestros</span> <span class="description-title">Mejores Destinos</span></div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="featured-destination">
              <!-- Destino destacado se cargará aquí -->
            </div>
          </div>

          <div class="col-lg-6">
            <div class="row g-3" id="other-destinations">
              <!-- Otros destinos se cargarán aquí -->
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Script para cargar destinos dinámicamente -->
    <script>
    document.addEventListener('DOMContentLoaded', async function() {
      try {
        // Cargar datos de destinos
        const response = await fetch('assets/data/destinos.json');
        ...
        if (data.featured) {
          const dest = data.featured;
          const featuredHtml = `
            <div class="destination-overlay">
              <img src="${dest.imagen}" alt="${dest.nombre}" class="img-fluid">
              <div class="destination-info">
                <span class="destination-tag">${dest.etiqueta || 'Popular'}</span>
                <h3>${dest.nombre}</h3>
                <p class="location"><i class="bi bi-geo-alt-fill"></i> ${dest.ubicacion}</p>
                <p class="description">${dest.descripcion}</p>
                <div class="destination-meta">
                  <div class="tours-count">
                    <i class="bi bi-collection"></i>
                    <span>${dest.tours || 0} Paquetes</span>
                  </div>
                  <div class="rating">
                    <i class="bi bi-star-fill"></i>
                    <span>${dest.calificacion || '4.5'} (${dest.reseñas || '0'})</span>
                  </div>
                </div>
                <div class="price-info">
                  <span class="starting-from">Desde</span>
                  <span class="amount">$${formatNumber(dest.precio || 0)}</span>
                </div>
                <a href="destination-details.html?dest=${encodeURIComponent(dest.id || '')}" class="explore-btn">
                  <span>Explorar</span>
          ...
          document.querySelector('.featured-destination').innerHTML = featuredHtml;
        }
        
        // Mostrar otros destinos
        const otherDests = data.otros || [];
        const otherDestsHtml = otherDests.map((dest, index) => `
          <div class="col-12" data-aos="fade-left" data-aos-delay="${300 + (index * 100)}">
            <div class="compact-destination">
              <div class="destination-image">
                <img src="${dest.imagen}" alt="${dest.nombre}" class="img-fluid">
                ${dest.etiqueta ? `<div class="badge-offer ${dest.etiqueta.toLowerCase()}">${dest.etiqueta}</div>` : ''}
              </div>
              <div class="destination-details">
                <h4>${dest.nombre}</h4>
                <p class="location"><i class="bi bi-geo-alt"></i> ${dest.ubicacion}</p>
                <p class="brief">${dest.descripcion}</p>
                <div class="stats-row">
                  <span class="tour-count"><i class="bi bi-calendar-check"></i> ${dest.tours || 0} Tours</span>
                  <span class="rating"><i class="bi bi-star-fill"></i> ${dest.calificacion || '4.5'}</span>
                  <span class="price">desde $${formatNumber(dest.precio || 0)}</span>
                </div>
                <a href="destination-details.html?dest=${encodeURIComponent(dest.id || '')}" class="quick-link">
        ...
        document.getElementById('other-destinations').innerHTML = otherDestsHtml;
        
      } catch (error) {
        console.error('Error al cargar los destinos:', error);
        // Mostrar mensaje de error en la interfaz
        document.querySelector('.featured-destination').innerHTML = '<p>No se pudieron cargar los destinos. Por favor, intente más tarde.</p>';
      }
    });
    </script><!-- /Featured Destinations Section -->
